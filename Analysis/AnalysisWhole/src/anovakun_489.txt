...
# 32)anovakun version 4.8.7（R 4.2.0，R 4.2.1作成；2022.7.1公開）
# ・R 4.2.0以降での単純主効果の出力エラーを修正；simeffects.out関数の修正
# 33)anovakun version 4.8.8（R 4.2.2，R 4.2.3作成；2023.4.3公開）
# ・マルチバイト文字を出力したときの表の出力を修正；table.out関数の修正
# 34)anovakun version 4.8.9（R 4.2.3，R 4.3.0作成；2023.5.1公開）
# ・version 4.8.8の出力の問題点を修正；table.out関数の修正
#
# 【この関数の使用に関して】
...
anovakun <- function(dataset, design, ..., long = FALSE, type2 = FALSE, nopost = FALSE, tech = FALSE, data.frame = FALSE, copy = FALSE, 
	...
	info2 <- paste0("This output was generated by anovakun 4.8.9 under ", strsplit(R.version$version.string, " \\(")[[1]][1], ".")# バージョン情報など
